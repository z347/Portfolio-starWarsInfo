(this.webpackJsonpclient = this.webpackJsonpclient || []).push([
    [0],
    {
        ...
        43: function (e, t, a) {
            ...
            var n = a(0),
                    ...
                    function (e) {
                        ...
                        return r.a.createElement(
                            ...
                            r.a.createElement(
                                'h3',
                                null,
                                r.a.createElement(m.b, { to: '/' }, 'StarDB')
                            ),
                            r.a.createElement(
                                'ul',
                                { className: 'd-flex' },
                ...
                b = function e() {
                    ...
                    Object(l.a)(this, e),
                        ...
                        (this.getAllStarships = Object(N.a)(
                            v.a.mark(function e() {
                                var a;
                                return v.a.wrap(function (e) {
                                    for (;;)
                        ...
                        (this.getPersonImage = function (e) {
                            var a = e.id;
                            return ''
                                .concat(t._imageBase, '/characters/')
                                .concat(a, '.jpg');
                        }),
                        (this.getStarshipImage = function (e) {
                            var a = e.id;
                            return ''
                                .concat(t._imageBase, '/starships/')
                                .concat(a, '.jpg');
                        }),
                        (this.getPlanetImage = function (e) {
                            var a = e.id;
                            return ''
                                .concat(t._imageBase, '/planets/')
                                .concat(a, '.jpg');
                        }),
                        (this._extractId = function (e) {
                            return e.url.match(/\/([0-9]*)\/$/)[1];
                        }),
                        (this._transformPlanet = function (e) {
                            return {
                                id: t._extractId(e),
                                name: e.name,
                        ...
                        (this._transformStarship = function (e) {
                            return {
                                id: t._extractId(e),
                                name: e.name,
                                model: e.model,
                                manufacturer: e.manufacturer,
                                costInCredits: e.cost_in_credits,
                                length: e.length,
                                crew: e.crew,
                                passengers: e.passengers,
                                cargoCapacity: e.cargo_capacity
                            };
                        }),
                        (this._transformPerson = function (e) {
                            return {
                                id: t._extractId(e),
                                name: e.name,
                                gender: e.gender,
                    ...
                    (function (e) {
                        ...
                        function a() {
                            ...
                            return (
                                ...
                                (e.state = { planet: {}, loading: !0 }),
                                (e.onPlanetLoaded = function (t) {
                                    e.setState({
                                        planet: t,
                                        loading: !1,
                                        error: !1
                                ...
                                (e.onError = function (t) {
                                    e.setState({ error: !0, loading: !1 });
                                }),
                                (e.updatePlanet = function () {
                                    var t = Math.floor(17 * Math.random()) + 2;
                                    e.swapiService
                                        .getPlanet(t)
                                        .then(e.onPlanetLoaded)
                                        .catch(e.onError);
                                }),
                                e
                            );
                            ...
                            Object(i.a)(a, [
                                {
                                    ...
                                    value: function () {
                                        var e = this.props.updateInterval;
                                        this.updatePlanet(),
            ...
            U.defaultProps = { updateInterval: 1e4 };
            var S = function (e) {
                    var t = e.planet,
                        a = t.id,
                        n = t.name,
                    ...
                    return r.a.createElement(
                        ...
                        r.a.createElement('img', {
                            ...
                            src: 'https://starwars-visualguide.com/assets/img/planets/'.concat(
                                a,
                                '.jpg'
                            ),
                            alt: 'planet'
                ...
                y = function e() {
                    ...
                    Object(l.a)(this, e),
                        ...
                        (this.getPersonImage = function () {
                            return 'https://placeimg.com/400/500/people';
                        }),
                        (this.getStarshipImage = function () {
                            return 'https://placeimg.com/600/400/tech';
                        }),
                        (this.getPlanetImage = function () {
                                    ...
                                    value: function () {
                                        ...
                                        return (
                                            ...
                                            r.a.createElement(
                                                ...
                                                {
                                                    className:
                                                        'error-button btn btn-danger btn-lg',
                                                    onClick: function () {
                                                        return e.setState({
                                                            renderError: !0
                                                        });
                ...
                k =
                    ...
                    function (e) {
                        ...
                        return r.a.createElement(
                            'li',
                            { className: 'list-group-item' },
                            r.a.createElement('span', { className: 'term' }, n),
                    ...
                    return (
                        Object(i.a)(a, [
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    (this.props.itemId === e.itemId &&
                                        this.props.getData === e.getData &&
                ...
                D = function (e) {
                    return function (t) {
                        return function (a) {
                            return r.a.createElement(T, null, function (n) {
                                var c = e(n);
                                return r.a.createElement(
                                    t,
                                    Object.assign({}, a, c)
                ...
                B = function (e) {
                    return function (t) {
                        return function (a) {
                            return r.a.createElement(t, a, e);
                        };
                    };
                },
                V = D(function (e) {
                ...
                F = D(function (e) {
                    return {
                        getData: e.getStarship,
                        getImageUrl: e.getStarshipImage
                    };
                })(function (e) {
                    return r.a.createElement(
                        O,
            ...
            R.defaultProps = { onItemSelected: function () {} };
            var _ = C(R, new b().getAllPeople),
                G = function (e) {
                    var t = e.name;
                ...
                K = x(
                    D(function (e) {
                        return { getData: e.getAllPlanets };
                    }),
                    C,
                    B(G)
                )(_),
                Z = x(
                    D(function (e) {
                        return { getData: e.getAllStarships };
                    }),
                    C,
                    B(function (e) {
                        var t = e.model,
                            a = e.name;
                        return r.a.createElement('span', null, a, ' (', t, ')');
                    })
                )(_),
                H =
                    (a(41),
                ...
                X = Object(I.g)(function (e) {
                    var t = e.history,
                        a = e.match.params.id;
                    return r.a.createElement(H, {
                        left: r.a.createElement(Q, {
                            onItemSelected: function (e) {
                                return t.push(e);
                            }
                        }),
                        right: r.a.createElement(V, { itemId: a })
                    });
                }),
                J = (function (e) {
                    Object(s.a)(a, e);
                        ...
                        Object(i.a)(a, [
                            {
                                ...
                                value: function () {
                                    ...
                                    return r.a.createElement(H, {
                                        left: r.a.createElement(K, {
                                            onItemSelected: this.onItemSelected
                                        }),
                                        right: r.a.createElement(L, {
                                            itemId: e
                                        })
                                    });
                                }
                ...
                Y = function (e) {
                    ...
                    return t
                        ...
                        : r.a.createElement(
                              ...
                              r.a.createElement(
                                  'button',
                                  { className: 'btn btn-primary', onClick: a },
                                  'Login'
                              )
                          );
                },
                q = function (e) {
                    return e.isLoggedIn
                        ...
                        : r.a.createElement(I.a, { to: '/login' });
                },
                $ =
                    (a(42),
                    (function (e) {
                        ...
                        function a() {
                            ...
                            return (
                                ...
                                (e.onServiceChange = function () {
                                    e.setState(function (e) {
                                        return {
                                            swapiService: new (e.swapiService instanceof
                                            b
                                                ? y
                                                : b)()
                                        };
...
//# sourceMappingURL=main.1b02bf6c.chunk.js.map
